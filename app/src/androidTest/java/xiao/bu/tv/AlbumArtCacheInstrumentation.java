...
public final class AlbumArtCacheInstrumentation extends Instrumentation {
    ...
    @Override public void onStart() {
        ...
        try (ServerSocket server = new ServerSocket(0)) {
            ...
            origin.join(10000); server.close();
            // Discard the decoded hot cache so this still exercises offline disk reads.
            java.lang.reflect.Field memory = AlbumArtLoader.class.getDeclaredField("decoded");
            memory.setAccessible(true);
            ((android.util.LruCache<?, ?>) memory.get(null)).evictAll();

...
public final class FlyMouseCursorView extends View {
    ...
    void setDrawSuppressed(boolean suppressed) {
        ...
        // Alpha also suppresses an existing hardware display list on a virtual
        // display; don't depend on a partial dirty rect clearing captured pixels.
        setAlpha(suppressed ? 0f : 1f);
        cancelFeedbackFrame();
        invalidate();
    }
